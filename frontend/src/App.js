      ...
      <div className="App">
        <Switch>
          ...
          <Route exact path='/dashboard@member'>
            {user ? (user.isAdmin === false ? <MemberDashboard /> : <Redirect to='/dashboard@admin' />) : <Redirect to='/' />}
          </Route>

          <Route exact path='/dashboard@admin'>
            {user ? (user.isAdmin === true ? <AdminDashboard /> : <Redirect to='/dashboard@member' />) : <Redirect to='/' />}
          </Route>
