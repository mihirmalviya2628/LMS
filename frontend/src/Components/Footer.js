            ...
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        ...
                        <p>Madhya  Pradesh</p>
                        <p>India</p>
                        <p><b>Email:</b>example@acropolis.in</p>
                    </div>
                ...
                <div className="contact-social" >
                    ...
                    <a href='https://www.instagram.com/mihir.malviya_/' className='social-icon'><InstagramIcon style={{ fontSize: 40,color:"rgb(283,83,75)"}} /></a>
                </div>
            </div>
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2023 copyright all right reserved<br /><span>Designed with ❤️ by Mihir Malviya</span></p>
            </div>
        </div>
    )
}
